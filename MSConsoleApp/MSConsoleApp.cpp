// MSConsoleApp.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//MB_OK 1
	//MB_OKCANCEL 1, 2
	//MB_ABORTRETRYIGNORE 3, 4, 5
	//MB_YESNOCANCEL 6, 7, 2
	//MB_YESNO 6, 7
	//MB_RETRYCANCEL 4, 2
	//IDOK                1
	//IDCANCEL            2
	...
	//IDYES               6
	//IDNO                7
	//int n = MessageBox(NULL, TEXT("Box1"), TEXT("Box 2"), MB_RETRYCANCEL); 

	// Set the text attributes to draw green text on blue background.
	if (! SetConsoleTextAttribute(hStdout, FOREGROUND_GREEN | FOREGROUND_INTENSITY | BACKGROUND_BLUE)) {
